...
%% Thesis title.
\newcommand{\thesistitle}{Evaluating ABR Algorithms under CellReplay and Mahimahi}


%% Author information.
%% (Used in a couple of places, so it's better to define them in one place.)
\newcommand{\thauthor}{Erin Elagöz}
%%  Student number.
\newcommand{\thauthorid}{2768668}
\newcommand{\thauthoremail}{e.elagoz@student.vu.nl}
