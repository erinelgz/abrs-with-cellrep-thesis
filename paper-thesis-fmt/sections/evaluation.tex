...
With improved network conditions, we used the same 5G traces in both Mahimahi and CellReplay environments to evaluate ABR performance. Using Figure~\ref{fig:mahimahi5g} and Table~\ref{tab:abr_results_mahimahi5g}, our objective is to compare these results to 4G traces, as well as to evaluate how different emulators change the behavior of ABR. All algorithms improved significantly in both quality and stability. The average BufRatio drop to between 0.046\% and 0.405\%, which shows that the capacity of 5G significantly affects BufRatio for every ABR. In particular, BOLA and MPC have averaged around 0.046\% and 0.048\% BufRatio, ranking as the best in BufRatio under 5G, while on 4G they were ranked as the worst. Their improvement shows that the stalling was likely due to limited bandwidth. They also serve a higher quality (SSIM around 0.9828 and 0.9831). This indicates that with sufficient bandwidth, BOLA and MPC can achieve stable and reasonably high-quality playback.
...
In conclusion, beyond variations in emulator choice, trace variation is also a key factor, affecting how ABR algorithms behave. It is crucial to design algorithms that adapt not only to bandwidth but also to RTT stability. Algorithms with stronger RTT handling perform better in dynamic traces. Therefore, it is important to test algorithms under various realistic trace patterns to find their true characteristics.
